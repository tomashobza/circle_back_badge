...
// MeshLine geometry type with setPoints method
...
function Band({ maxSpeed = 50, minSpeed = 10 }) {
  ...
  const { nodes, materials } = useGLTF("/circle_back_badge.glb");
  const texture = useTexture("/band.jpg");
  // Configure texture wrapping (required for proper UV mapping)
  /* eslint-disable */
  ...
  return (
    <>
      ...
      <mesh ref={band}>
        {/* @ts-expect-error - meshLineGeometry is added via extend() */}
        <meshLineGeometry />
        {/* @ts-expect-error - meshLineMaterial is added via extend() */}
        <meshLineMaterial
          color="white"
          depthTest={false}
